...
import {
  ...
  DARK, INK, TEXT_BODY, TEXT_MUTED, TEXT_SOFT,
  TEXT_ON_DARK, BADGE_TEXT, BORDER,
} from "../theme";
  ...
  if (loading) {
    return (
      <div style={{ background:"#fff", ...fontHead, minHeight:"100vh" }}>
        <Navbar />
        <div style={{ textAlign:"center", padding:"180px 0", color:TEXT_SOFT }}>Loading article…</div>
        <Footer />
      </div>
    );
  }
    ...
    return (
      <div style={{ background:"#fff", ...fontHead, minHeight:"100vh" }}>
        ...
        <div style={{ textAlign:"center", padding:"160px 24px" }}>
          ...
          <p style={{ fontSize:17, color:TEXT_MUTED, marginBottom:28 }}>This post may have moved or been removed.</p>
    ...
    <div style={{ background:"#fff", ...fontHead, overflowX:"hidden" }}>
      ...
      <section style={{ position:"relative", background:`linear-gradient(135deg, ${DARK} 0%, #14172a 55%, #1a2348 100%)`, color:"#fff", paddingTop:140, paddingBottom:70, overflow:"hidden" }}>
        ...
        <div style={{ ...wrap, position:"relative", textAlign:"center" }}>
          <button onClick={()=>navigate("/blog")} style={{ ...fontHead, background:"rgba(255,255,255,0.08)", color:BADGE_TEXT, border:"1px solid rgba(255,255,255,0.18)", padding:"8px 18px", borderRadius:30, fontSize:13.5, fontWeight:600, cursor:"pointer", marginBottom:24 }}>← Back to Blog</button>
          <div>
          ...
          <div style={{ display:"flex", alignItems:"center", gap:16, justifyContent:"center", fontSize:14, color:TEXT_ON_DARK }}>
      ...
      <article style={{ background:"#fff", padding:"70px 0 90px" }}>
        <div style={{ ...wrap }}>
          {post.excerpt && (
            <p style={{ fontSize:21, lineHeight:1.6, color:INK, fontWeight:500, margin:"0 0 36px", paddingBottom:32, borderBottom:`1px solid ${BORDER}` }}>{post.excerpt}</p>
          )}
          <div style={{ fontSize:17.5, lineHeight:1.85, color:TEXT_BODY, whiteSpace:"pre-wrap" }}>
            {bodyText}
          </div>
        </div>
      </article>
      ...
      <section style={{ background:`linear-gradient(135deg, ${INK}, #1a2348)`, padding:"80px 0", position:"relative", overflow:"hidden", textAlign:"center" }}>
        ...
        <div style={{ maxWidth:1200, margin:"0 auto", padding:"0 24px", position:"relative" }}>
          ...
          <p style={{ fontSize:17, color:TEXT_ON_DARK, maxWidth:520, margin:"0 auto 30px" }}>Let's talk about what you're building. I respond personally within 24 hours.</p>
